package com.boheng.wiki.aspect;
...
public class LogAspect {
    ...
    @Pointcut("execution(public * com.boheng.*.controller..*Controller.*(..))")
    ...
    public void doBefore(JoinPoint joinPoint) throws Throwable {
        ...
        LOG.info("Name: {}.{}", signature.getDeclaringTypeName(), name);
    ...
    public Object doAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        LOG.info("------------- End Time Cost：{} ms -------------", System.currentTimeMillis() - startTime);
        return result;
    }
